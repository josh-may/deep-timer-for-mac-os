...
Since this app isn't distributed through the App Store (Apple charges $99/year for code signing), you'll need to remove the quarantine flag after downloading:
